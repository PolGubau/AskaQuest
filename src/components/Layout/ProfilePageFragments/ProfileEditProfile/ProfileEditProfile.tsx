      ...
      <div>
        {show && (
          <div className={styles.editProfileContainer}>
            ...
            <div className={styles.closeButton} onClick={handleChangeUsername}>
              <ButtonWithIcon icon="user" text="Change Username" />
            </div>
            <div className={styles.closeButton} onClick={handleChangePassword}>
              <ButtonWithIcon icon="password" text="Change Password" />
            </div>
            <div className={styles.closeButton} onClick={handleChangeEmail}>
              <ButtonWithIcon icon="email" text="Change Email" />
            </div>

            <div className={styles.closeButton} onClick={() => setShow(false)}>
              <ButtonWithIcon icon="close" text="Save" darkButton={true} />
            </div>
          </div>
        )}
      </div>
